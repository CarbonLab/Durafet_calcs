function [pHext_tot, pHext_free] = calc_dfet_pHext_k0(Eext, tempC, salt, k0, UseDefaultk2)
...
pHext_free = -(((k0+k2*(tempC))-Eext)-S_T.*(log10(mCl)+log10gamma_HCl))./S_T; % mol/kg-H2O
